...
function getDataFromTable(){
    ...
    var output = {results: [] };
    try {
        query = 'SELECT \"StationId\",count(*) FROM \"waysidecloudapp.dbtables::CrewPackageData\" WHERE (SECONDS_BETWEEN(\"StartDate\",CURRENT_TIMESTAMP)/86400<30) GROUP BY \"StationId\"';
